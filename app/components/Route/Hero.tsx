    ...
    return (
        <div className="w-full md:flex items-center">
            ...
            <div className="md:w-[60%] flex flex-col items-center md:text-left mt-[150px]">
                <h2 className="dark:text-white text-black text-[30px] px-3 w-full md:text-[70px] font-[600] font-Josefin py-2 md:!w-[78%]">
                    Khóa học lập trình C++ từ cơ bản đến nâng cao.
                </h2>
                <br />
                <p className="dark:text-white text-black font-Josefin font-[600] text-[18px] lg:!w-[55%] md:!w-[78%]">
                ...
                <div className="lg:w-[55%] md:w-[78%] w-[90%] h-[50px] relative">
                    <button type="submit" title="Xem Chi Tiết"></button>
                </div>
            </div>
        </div>
    );
